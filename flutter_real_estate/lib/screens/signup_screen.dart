...
// import '../main.dart'; 
// import 'package:firebase_auth/firebase_auth.dart'; // To check initialization
...
//     isUserLoggedIn = true; // Login ဝင်ကြောင်း မှတ်သားမည်
    
//     // Signup ကနေ ပြန်ထွက်ရင် Login Screen ကိုကျော်ပြီး MainScreen အထိ ရောက်အောင် 
//     // Pop (၂) ခါလုပ်ပြီး true ပို့ပေးပါမယ်။
//     Navigator.of(context).pop(); // Signup ကို ပိတ်
//     Navigator.of(context).pop(true); // Login ကို ပိတ်ပြီး MainScreen ဆီ အောင်မြင်ကြောင်းပို့
//   }
...
//                 const Text(
//                   "အကောင့်သစ် ဖွင့်မည်",
//                   style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: Color(0xFF2B3550)),
//                 ),
//                 const SizedBox(height: 8),
//                 const Text(
//                   "အိမ်ခြံမြေများကို လွယ်ကူစွာ ရှာဖွေ၊ ရောင်းဝယ်ရန် ယခုပဲ အကောင့်ဖွင့်လိုက်ပါ",
//                   style: TextStyle(fontSize: 14, color: Color(0xFF76799C), height: 1.5),
//                 ),
//                 const SizedBox(height: 30),

//                 _buildTextField(controller: _nameController, label: "အမည်အပြည့်အစုံ", icon: Icons.person_outline_rounded),
//                 const SizedBox(height: 16),
                
//                 _buildTextField(controller: _phoneController, label: "ဖုန်းနံပါတ်", icon: Icons.phone_android_rounded, keyboardType: TextInputType.phone),
//                 const SizedBox(height: 16),
...
//                 // Google Button
//                 _buildGoogleButton(onTap: _handleSignup),
...
//                   children: [
//                     const Text("အကောင့် ရှိပြီးသားလား? ", style: TextStyle(color: Color(0xFF76799C), fontSize: 14.5)),
//                     GestureDetector(
//                       onTap: () => Navigator.pop(context), // Back to login screen
//                       child: const Text("အကောင့်ဝင်မည်", style: TextStyle(color: Color(0xFF3577F6), fontSize: 14.5, fontWeight: FontWeight.w800)),
//                     ),
//                   ],
//                 ),
//               ],
...
//   // (Login ထဲက method များနှင့် အတူတူပါပဲ)
...
//               const Text("Gmail Login", style: TextStyle(fontSize: 15.5, fontWeight: FontWeight.bold, color: Color(0xFF2B3550))),
//             ],
//           ),
//         ),
//       ),
